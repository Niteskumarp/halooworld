...
// $partnerid = rand(10);
  if( !empty($email) && !empty($partnerid) && !empty($password))
  {
    ...
    if ($query){
      ...
      $body = "Hi, This is your login credentials for HalooWorld Username:$to_email partner id:$partnerid fallow this link -->, $complete_url  ";
                  ...
                  <form action="#" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="partnerid" class="form-control" id="yourpartnerid"  >
